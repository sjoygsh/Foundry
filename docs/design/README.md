...
| `assets.md` | M3 | The asset registry, ID resolution and hot reload. M2 stands up `asset` as decoding plus a path-keyed cache only, deliberately settling none of that (CLAUDE.md §9). |
