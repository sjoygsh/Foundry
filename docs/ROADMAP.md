...
### M15 — Editor: "content is authored in Foundry" — **in progress: Step 1 of 9 done**
...
author/consumer proof; closure. Step 1 is done (2026-09-20); the rest are unstarted. The first editor authors records using
