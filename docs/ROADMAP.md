...
### M14 — Managed: "players choose their mods" — **in progress: Steps 1 to 3 of nine done, 2026-09-19**
...
are on settings version 2 and profiles, and their M9-era files convert. Step 4, the UI kernel's
additions, is next.
