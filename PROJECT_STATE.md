...
**Current handoff: M0 through M10 are complete. M11 is under way, 6/9 steps implemented.
Stop immediately before M11 Step 7. M12 through M17 remain unstarted.**
...
6/9 steps implemented; M12 through M17 are unstarted.
...
a solid patch in the font's texture, and the reference font has one. Implementation is paused
before §12 Step 7; the remaining known-debt entries are not claimed repaired.
